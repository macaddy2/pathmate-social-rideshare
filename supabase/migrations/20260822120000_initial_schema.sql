-- PathMate baseline migration generated from the repository schema.
-- The source schema remains available for reference; this ordered copy ensures
-- all tables exist before their RLS policies are created.
